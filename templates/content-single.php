...
<!-- Post Item Start -->
	<article id="post_<?php the_ID(); ?>" <?php post_class('row format-standard single-post'); ?>>
		<?php 
		// Post visitor count 
		pastelinterior_set_post_views( get_the_ID() );
		 ...
		 * Post social share
		 * @Hook  pastelinterior_blog_posts_content
		 *
		 * @Hooked pastelinterior_blog_posts_content_cb
		 * 
		 *
		 */
		do_action( 'pastelinterior_blog_posts_content' );
