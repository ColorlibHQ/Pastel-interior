...
// image default alt
if( !function_exists( 'pastelinterior_img_default_alt' ) ){
	function pastelinterior_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'pastelinterior_img_tag' ) ){
	function pastelinterior_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = pastelinterior_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'pastelinterior_anchor_tag' ) ){
	function pastelinterior_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'pastelinterior_heading_tag' ) ){
	function pastelinterior_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'pastelinterior_paragraph_tag' ) ){
	function pastelinterior_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'pastelinterior_other_tag' ) ){
	function pastelinterior_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'pastelinterior_button_element ' ) ){
	function pastelinterior_button_element( array $args ){
