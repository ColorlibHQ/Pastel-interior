<?php
function pastelinterior_portfolio_metabox( $meta_boxes ) {

	$meta_boxes[] = array(
		'id'        => 'portfolio_single_metaboxs',
		'title'     => esc_html__( 'Portfolio Single Metabox', 'pastel-interior' ),
		...
		'fields'    => array(
			array(
				'id'    => 'client_name',
				'type'  => 'text',
				'name'  => esc_html__( 'Client Name', 'pastel-interior' ),
				'placeholder' => esc_html__( 'Client Name', 'pastel-interior' ),
			),
			array(
				'id'    => 'project_date',
				'type'  => 'date',
				'name'  => esc_html__( 'Project Date', 'pastel-interior' ),
				'js_options' => array(
					'dateFormat'      => 'M dd, yy   ',
			...
			array(
				'name'    => esc_html__( 'Star Review', 'pastel-interior' ),
				'id'      => 'project_review',
				'type'    => 'button_group',
				'options' => array(
			...
			array(
				'name'    => esc_html__( 'Gird Image Size', 'pastel-interior' ),
				'id'      => 'portfolio-grid',
				'type'    => 'select',
				'options' => array(
					'0' => 'Select Size',
...
add_filter( 'rwmb_meta_boxes', 'pastelinterior_portfolio_metabox' );