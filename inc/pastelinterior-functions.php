...
/*=========================================================
	Image Crop Size
=========================================================*/
add_image_size( 'pastelinterior_blog_750x375', 750, 375, true );
add_image_size( 'pastelinterior_60x60', 60, 60, true );
add_image_size( 'pastelinterior_latest_blog_360x280', 360, 280, true );
add_image_size( 'pastelinterior_950x500', 950, 500, true );
add_image_size( 'pastelinterior_recent_360x380', 360, 380, true );
add_image_size( 'pastelinterior_1920x800', 1920, 800, true );

add_image_size( 'pastelinterior_390x450', 390, 450, true );
add_image_size( 'project_430x580', 430, 580, true );
...
=========================================================*/
function pastelinterior_opt( $id = null, $default = '' ) {
 ...
 *  Social Profile
 * ====================================================*/
function pastelinterior_social_profile() {
	$social_urls = pastelinterior_opt( 'pastelinterior_social_pofile' );
            ...
            <div class="d-flex">
                <div class="social_area">
					...
					foreach ( $social_urls as $social_pro ) {
						echo '<h4><a href="' . esc_url( $social_pro['social_url'] ) . '">' . esc_html( $social_pro['profile_name'] ) . '</a></h4>';
					}
					?>
                </div>
            </div>
...
/*=========================================================
	Blog Date Permalink
=========================================================*/
function pastelinterior_blog_date_permalink(){
...
/*========================================================
	Blog Excerpt Length
========================================================*/
if ( ! function_exists( 'pastelinterior_excerpt_length' ) ) {
	function pastelinterior_excerpt_length( $limit = 30 ) {
...
if ( ! function_exists( 'pastelinterior_posted_comments' ) ) {
    function pastelinterior_posted_comments( $icon = true ){
        ...
        if( comments_open() ){
            if( $comments_num == 0 ){
                $comments = esc_html__('No Comments','pastel-interior');
            } elseif ( $comments_num > 1 ){
                $comments= $comments_num . esc_html__(' Comments','pastel-interior');
            } else {
                $comments = esc_html__( '1 Comment','pastel-interior' );
            }
            $comments = '<a href="' . esc_url( get_comments_link() ) . '">'. $icon . $comments .'</a>';
        } else {
            $comments = esc_html__( 'Comments are closed', 'pastel-interior' );
        }
...
/*===================================================
	Post embedded media
===================================================*/
function pastelinterior_embedded_media( $type = array() ){
...
/*===================================================
	WP post link pages
====================================================*/
function pastelinterior_link_pages(){
    wp_link_pages( array(
    'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'pastel-interior' ) . '</span>',
    'after'       => '</div>',
    'link_before' => '<span>',
    'link_after'  => '</span>',
    'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'pastel-interior' ) . ' </span>%',
...
/*====================================================
	Theme logo
====================================================*/
function pastelinterior_theme_logo( $class = '' ) {
...
/*================================================
    Page Title Bar
================================================*/
function pastelinterior_page_titlebar() {
                    ...
                    <div class="banner_content d-md-flex justify-content-between align-items-center">
                        <div class="mb-3 mb-md-0">
                            <h2>
	                            <?php
	                            if ( is_category() ) {
		                            single_cat_title( __('Category: ', 'pastel-interior') );
		                            ...
		                            echo esc_html__( 'Search for: ', 'pastel-interior' ) . get_search_query();

	                            } elseif ( ! ( is_404() ) && ( is_single() ) || ( is_page() ) ) {
		                            echo  get_the_title();

	                            } elseif ( is_home() ) {
		                            echo esc_html__( 'Blog', 'pastel-interior' );

	                            } elseif ( is_404() ) {
		                            echo esc_html__( '404 error', 'pastel-interior' );
                        ...
                        <?php
                        if ( function_exists( 'pastelinterior_breadcrumbs' ) ) {
                            pastelinterior_breadcrumbs();
                        }
                        ?>
                    </div>
                </div>
...
=================================================*/
function pastelinterior_pull_right( $id = '', $condation ){
...
/*======================================================
	Inline Background
======================================================*/
function pastelinterior_inline_bg_img( $bgUrl ){
    $bg = '';
...
/*======================================================
	Blog Category
======================================================*/
function pastelinterior_featured_post_cat(){
...
========================================================*/
function pastelinterior_sidebar_opt(){

    $sidebarOpt = pastelinterior_opt( 'pastelinterior_blog_layout' );
    $sidebar = '1';
...
/**================================================
	Themify Icon
 =================================================*/
function pastelinterior_themify_icon(){
    return[
        'ti-home'       => 'Home',
        'ti-tablet'     => 'Tablet',
        'ti-email'      => 'Email',
...
============================================================*/
function pastelinterior_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'pastelinterior_contact7_form_content', 10, 2 );
...
/*============================================================
	Pagination
=============================================================*/
function pastelinterior_blog_pagination(){
	echo '<nav class="blog-pagination justify-content-center d-flex">';
        the_posts_pagination(
            array(
                'mid_size'  => 2,
                'prev_text' => __( '<span class="ti-angle-left"></span>', 'pastel-interior' ),
                'next_text' => __( '<span class="ti-angle-right"></span>', 'pastel-interior' ),
                'screen_reader_text' => ' '
            )
        );
	echo '</nav>';
...
=============================================================*/
if( ! function_exists('pastelinterior_blog_single_post_navigation') ) {
	function pastelinterior_blog_single_post_navigation() {
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
						...
						if( get_next_post_link() ){
							...
							if( has_post_thumbnail() ){
								...
								<div class="thumb">
									<a href="<?php the_permalink(  absint( $nextPost->ID )  ) ?>">
										<?php echo get_the_post_thumbnail( absint( $nextPost->ID ), 'pastelinterior_60x60', array( 'class' => 'img-fluid' ) ) ?>
									</a>
								</div>
								<?php
							} ?>
							...
							<div class="detials">
								<p><?php echo esc_html__( 'Prev Post', 'pastel-interior' ); ?></p>
								<a href="<?php the_permalink(  absint( $nextPost->ID )  ) ?>">
					...
					<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
						...
						if( get_previous_post_link() ){
							...
							?>
							<div class="detials">
								<p><?php echo esc_html__( 'Next Post', 'pastel-interior' ); ?></p>
							...
							<div class="thumb">
								<a href="<?php the_permalink(  absint( $prevPost->ID )  ) ?>">
									<?php echo get_the_post_thumbnail( absint( $prevPost->ID ), 'pastelinterior_60x60', array( 'class' => 'img-fluid' ) ) ?>
								</a>
							</div>
							<?php
						} ?>
...
/*=======================================================
	Author Bio
=======================================================*/
function pastelinterior_author_bio(){
...
/*===================================================
 Pastelinterior Comment Template Callback
 ====================================================*/
function pastelinterior_comment_callback( $comment, $args, $depth ) {
				...
				<div class="desc">
					...
					<div class="d-flex justify-content-between">
						<div class="d-flex align-items-center">
							<h5 class="comment_author"><?php printf( __( '<span class="comment-author-name">%s</span> ', 'pastel-interior' ), get_comment_author_link() ); ?></h5>
							<p class="date"><?php printf( __('%1$s at %2$s', 'pastel-interior'), get_comment_date(),  get_comment_time() ); ?><?php edit_comment_link( esc_html__( '(Edit)', 'pastel-interior' ), '  ', '' ); ?> </p>
							<?php if ( $comment->comment_approved == '0' ) : ?>
								<em class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'pastel-interior' ); ?></em>
								<br>
							<?php endif; ?>
						</div>
...
add_filter('comment_reply_link', 'pastelinterior_replace_reply_link_class');
function pastelinterior_replace_reply_link_class( $class ) {
...
===========================================================*/
function pastelinterior_latest_blog( $post_num ){
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog">
                    ...
                    if( has_post_thumbnail() ){ ?>
                        <div class="thumb">
                            <?php
                            the_post_thumbnail( 'pastelinterior_latest_blog_360x280' ); ?>
                            <div class="meta-top d-flex">
                                <a href="<?php echo esc_url( pastelinterior_blog_date_permalink() ) ?>"><?php the_time('M j, Y') ?></a>
                                <?php echo pastelinterior_posted_comments( false ) ?>
                            </div>
                        </div>
                        <?php
                    }
...
/*=========================================================
    Share Button Code
===========================================================*/
function pastelinterior_social_sharing_buttons( $ulClass = '', $tagLine = '' ) {
 ...
 *  Flaticon Icon List
=========================================================*/
function pastelinterior_flaticon_list(){
    return(
        array(
            'flaticon-leaf'     => 'Leaf',
            'flaticon-send'     => 'Send',
...
// Page Sub Title Meta ============================
function pastelinterior_page_titlebar_meta() {
	add_meta_box("pastelinterior_page_title", esc_html__( "Page Sub Title", 'pastelinterior' ), "page_titlebar_markup", "page", "side", "high", null);
}
add_action('add_meta_boxes', 'pastelinterior_page_titlebar_meta');

function page_titlebar_markup($post) {
    $subtitle = get_post_meta($post->ID, 'subtitle_input_meta', true);
    ?>
	<label for="psub_title"><?php echo esc_html__( 'Sub Title', 'pastelinterior' ) ?></label>
