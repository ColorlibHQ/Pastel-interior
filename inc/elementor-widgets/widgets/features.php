 ...
 * @since 1.0
 */
class Pastelinterior_Features extends Widget_Base {

	public function get_name() {
		return 'pastelinterior-features';
	}

	public function get_title() {
		return __( 'Features', 'pastel-interior' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'features_block',
			[
				'label' => __( 'Features', 'pastel-interior' ),
			]
		);
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Features', 'pastel-interior' ),
                ...
                'fields' => [
                    [
                        ...
                        'label_block' => true,
                        'default' => __('Money back gurantee', 'pastel-interior')
                    ],
	                [
		                'name'  => 'desc',
		                'label' => __( 'Description', 'pastel-interior' ),
                        'type'  => Controls_Manager::TEXTAREA,
                        'default' => __('Shall open divide a one', 'pastel-interior')
	                ],
                    [
		                'name'  => 'icon',
                    ...
                    [
		                'name'  => 'title_url',
		                'label' => __( 'Title link', 'pastel-interior' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'pastel-interior' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'pastel-interior' ),
        ...
        $this->add_control(
            'title_hover_bg', [
                'label' => __( 'Feature Hover Border Color', 'pastel-interior' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#eff2f3',
                'selectors' => [
