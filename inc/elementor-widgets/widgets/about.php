 ...
 * @since 1.0
 */
class Pastelinterior_About extends Widget_Base {

	public function get_name() {
		return 'pastelinterior-about';
	}

	public function get_title() {
		return __( 'About', 'pastel-interior' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'about_content',
			[
				'label' => __( 'About Us', 'pastel-interior' ),
			]
		);
        $this->add_control(
            'section_title',
            [
                'label'         => esc_html__( 'Section Title', 'pastel-interior' ),
        ...
        $this->add_control(
            'button_label',
            [
                'label'         => esc_html__( 'Button Label', 'pastel-interior' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__('Learn More', 'pastel-interior')
            ]
        );
        $this->add_control(
            'button_url',
            [
                'label'         => esc_html__( 'Button URL', 'pastel-interior' ),
		...
		$this->add_control(
			'img_caption',
			[
				'label'         => esc_html__( 'Image Caption', 'pastel-interior' ),
				'description'   => __( 'Use Blod for color & bold text', 'pastel-interior' ),
				'type'          => Controls_Manager::WYSIWYG,
				'label_block'   => true,
				'default'       => __('<span>26</span>Years of Awesomeness', 'pastel-interior')
			]
		);
		...
		$this->start_controls_section(
			'about_feature_image',
			[
				'label' => __( 'Featured Images', 'pastel-interior' ),
			]
		);
		$this->add_control(
			'about_img1',
			[
				'label'         => esc_html__( 'Featured Image Layer 1', 'pastel-interior' ),
		...
		$this->add_control(
			'bg_heading1',
			[
				'label'         => esc_html__( 'Featured Image Pattern Top', 'pastel-interior' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Featured Image Pattern Top', 'pastel-interior' ),
				'types' => [ 'classic' ],
		...
		$this->add_control(
			'bg_heading2',
			[
				'label'         => esc_html__( 'Featured Image Pattern Bottom', 'pastel-interior' ),
				'type'          => Controls_Manager::HEADING,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Featured Image Pattern Bottom', 'pastel-interior' ),
				'types' => [ 'classic' ],
		...
		$this->add_control(
			'bg_heading3',
			[
				'label'         => esc_html__( 'Image Caption Background Pattern ', 'pastel-interior' ),
				'type'          => Controls_Manager::HEADING,
			]
		);
		$this->add_group_control(
        ...
        $this->start_controls_section(
            'stylecolor', [
                'label' => __( 'Style Featuer', 'pastel-interior' ),
        ...
        $this->add_control(
            'btn_border_color', [
                'label'     => __( 'Button Border Color', 'pastel-interior' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'btn_hover_border_color', [
                'label'     => __( 'Button Hover Border Color', 'pastel-interior' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
	...
	protected function render() {
		...
		$feature_img1 = !empty( $settings['about_img1']['id'] ) ? wp_get_attachment_image( $settings['about_img1']['id'], 'pastelinterior_390x450', false, array( 'class' => 'styleBox-img1' ) ) : '';
