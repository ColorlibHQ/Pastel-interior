 ...
 * @since 1.0
 */
class Pastelinterior_Cta extends Widget_Base {

    public function get_name() {
        return 'pastelinterior-cta';
    }

    public function get_title() {
        return __( 'Cta', 'pastel-interior' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Cta Info', 'pastel-interior' ),
            ]
        );
	    $this->add_control(
		    'cta_title',
		    [
			    'label'     => esc_html__( 'Cta Title', 'pastel-interior' ),
			    'type'      => Controls_Manager::TEXT,
			    'label_block' => true,
			    'default'   => esc_html__('GET A QUICK RESPONSE FROM OUR TEAM', 'pastel-interior')
		    ]
	    );
	    $this->add_control(
		    'sub_title',
		    [
			    'label'     => esc_html__( 'Subtitle Title', 'pastel-interior' ),
			    'type'      => Controls_Manager::TEXTAREA,
			    'label_block' => true,
			    'default'   => esc_html__('Get to Know Project Estimate?', 'pastel-interior')
		    ]
	    );
	    $this->add_control(
		    'btn_label',
		    [
			    ...
			    'type'      => Controls_Manager::TEXT,
			    'label_block' => true,
			    'default'   => esc_html__('Get a quote now', 'pastel-interior')
		    ]
	    );
	    $this->add_control(
		    'btn_url',
	    ...
	    $this->start_controls_tab(
		    'style_normal_tab',
		    [
			    'label' => __( 'Normal', 'pastel-interior' ),
		    ]
	    );
	    $this->add_control(
		    'btn_lcolor', [
	    ...
	    $this->start_controls_tab(
		    'style_hover_tab',
		    [
			    'label' => __( 'Hover', 'pastel-interior' ),
		    ]
	    );
            ...
            <div class="container">
                <div class="row call_to_action_inner">
                    ...
                    <div class="col-md-5">
                        <?php
                        if( $btn_label ){
                            echo '<a href="'. esc_url( $btn_url ) .'" class="main_btn_2">'. esc_html( $btn_label ) .'<span '. button_bg() .'><img src="'. PASTELINTERIOR_DIR_IMG .'arrow.png" alt="'. esc_html__('Button pattern background', 'pastel-interior' ) .'"></span></a>';
                        }
                        ?>
                    </div>
                </div>
