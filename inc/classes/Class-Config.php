 ...
 */
	...
	// Final Class
	final class Pastelinterior{

		
		// Theme Version
		private $pastelinterior_version = '1.0';
		...
		private function setup(){
			...
			$enqueu = new pastelinterior_Enqueue();
			$enqueu->scripts = $this->enqueue() ;
			$enqueu->pastelinterior_scripts_enqueue_init() ;

		}
		// Theme Support
		public function support(){
			// content width
	        $GLOBALS['content_width'] = apply_filters( 'pastelinterior_content_width', 751 );

	        
	        // text domain for translation.
	        load_theme_textdomain( 'pastel-interior', PASTELINTERIOR_DIR_PATH . '/languages' );
			...
			add_image_size( 'pastelinterior_widget_post_thumb', 80, 80, true );
	        ...
	        register_nav_menus( array(
	            'primary-menu'   => esc_html__( 'Primary Menu', 'pastel-interior' ),
	            'social-menu'    => esc_html__( 'Social Menu', 'pastel-interior' ),
	        ) );
		...
		private function enqueue(){
			...
			$cssPath = PASTELINTERIOR_DIR_CSS_URI;
			$jsPath  = PASTELINTERIOR_DIR_JS_URI;
		...
		private function google_font(){
			...
			if ( 'off' !== _x( 'on', 'Google font: on or off', 'pastel-interior' ) ) {
		...
		private function customizer_init(){
			...
			// Instantiate pastelinterior theme customizer
			$pastelinterior_theme_customizer = new pastelinterior_theme_customizer();
		}
		...
		public function epsilon_quickie(){
				...
				'links' => array(
					array(
						'link_to'   => 'pastelinterior_theme_options_panel',
