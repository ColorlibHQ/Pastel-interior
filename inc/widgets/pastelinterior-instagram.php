...
----------------------------------------*/
class pastelinterior_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('pastelinterior_instagram_photo',esc_html__('[ Pastelinterior ] Intagram Photo','pastel-interior'),array(
			'description' => esc_html__('Pastelinterior Instagram Photo Widget','pastel-interior'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'pastel-interior');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'pastel-interior'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'pastel-interior'); ?></label>
...
if(!function_exists('pastelinterior_instagram_widgets')):
	function pastelinterior_instagram_widgets(){
		register_widget('pastelinterior_instagram_photo');
	}
	add_action('widgets_init','pastelinterior_instagram_widgets');
endif;
