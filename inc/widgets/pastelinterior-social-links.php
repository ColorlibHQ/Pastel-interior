...
class Pastelinterior_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'pastelinterior_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Pastelinterior ] Social Links', 'pastel-interior' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'pastel-interior' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'pastel-interior' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'pastel-interior'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'pastel-interior'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'pastel-interior'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Behance URL:' ,'pastel-interior'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'pastel-interior'); ?></label>
...
} // Class pastelinterior_social_links ends here


// Register and load the widget
function pastelinterior_social_links_widget_load() {
	register_widget( 'Pastelinterior_social_links' );
}
add_action( 'widgets_init', 'pastelinterior_social_links_widget_load' );